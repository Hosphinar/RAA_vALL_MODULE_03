...
namespace RAA_vALL_MODULE_03
{
    ...
    public class Option_1_HardCoded_Class : IExternalCommand
    {
        ...
        //public FurnitureType GetFurnitureTypeByName(Document doc, FurnitureType familyName, FurnitureType typeName)
        //{
        //    foreach (FurnitureType curType in furnitureTypes) //<REFACTOR to add GetFurnitureType method>
        //    {
        //        if (furnItem.Trim() == curType.Name)
